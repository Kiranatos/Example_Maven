package net.kiranatos.variant3.controllers;
...
import net.kiranatos.variant3.interfaces.impls.CollectionAddressBook;
import net.kiranatos.variant3.objects.Person;
import net.kiranatos.variant3.utils.DialogManager;
...
public class MainController implements Initializable {
    ...
    @FXML
    private TableColumn<Person, String> columnFIO, columnPhone;
    ...
    private void initLoader() {
        try {
            ...
            fxmlLoader.setResources(ResourceBundle.getBundle("bundles.variant3.Locale", new Locale("ru")));
            fxmlEdit = fxmlLoader.load(MainController.class.getClass().getResourceAsStream("/fxml/variant3/edit.fxml"));
